...
namespace DesignPatterns.UnitOfWorkDesignPattern
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //AddEntityFrameworkNpgsql() eklememizin sebebi → “EF Core, ben PostgreSQL ile çalışacağım” demek.
            //Kısaca: hangi veritabanı sağlayıcısını(provider) kullanacağını belirtmek için.
            //Bu ifade, uygulamanızın PostgreSQL veritabanıyla çalışabilmesi için zorunlu bir adımdır.

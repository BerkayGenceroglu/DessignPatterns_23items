...
namespace DesignPattern.Facade.Migrations
{
    ...
    [Migration("20250925142618_mignew")]
            ...
            modelBuilder.Entity("DesignPattern.Facade.DAL.OrderDetail", b =>
                {
                    ...
                    b.Property<decimal>("ProductUnitTotalPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DesignPattern.Facade.DAL.Order", b =>
                {
                    ...
                    b.HasOne("DesignPattern.Facade.DAL.Order", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderId1");

                    b.HasOne("DesignPattern.Facade.DAL.Product", null)
                        .WithMany("Orders")
